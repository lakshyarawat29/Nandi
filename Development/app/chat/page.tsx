...
import { ArrowLeft, Send, Mic, MicOff, Phone, MessageSquare, Volume2, Languages, User, Bot } from "lucide-react"
...
export default function ChatInterface() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "ai",
      content:
        "Namaste! I am your Krishi-Mudra AI assistant. How can I help you today? You can ask about weather, market prices, loans, or farming advice.",
      timestamp: new Date(),
      language: "english",
    },
  ])
  ...
  const quickActions: QuickAction[] = [
    { id: "1", label: "Weather Update", query: "What is today's weather forecast?", icon: "🌤️" },
    { id: "2", label: "Market Prices", query: "Show me today's mandi prices", icon: "💰" },
    { id: "3", label: "Loan Information", query: "I need information about agricultural loans", icon: "🏦" },
    { id: "4", label: "Crop Advice", query: "Give me advice for my wheat crop", icon: "🌾" },
    { id: "5", label: "Trust Score", query: "Check my current trust score", icon: "⭐" },
    { id: "6", label: "Satellite Data", query: "Show my farm's satellite analysis", icon: "🛰️" },
  ]
  ...
  const generateAIResponse = (userMessage: string): string => {
    ...
    if (message.includes("market") || message.includes("price") || message.includes("mandi")) {
    ...
    if (message.includes("crop") || message.includes("advice") || message.includes("farming")) {
                  ...
                  <CardHeader className="border-b border-border">
                    <div className="flex items-center justify-between">
                      <CardTitle className="flex items-center space-x-2">
                        ...
                        <span>Krishi-Mudra AI Assistant</span>
                      </CardTitle>
                      <Badge variant="outline">{languages.find((l) => l.value === selectedLanguage)?.label}</Badge>
                    </div>
                  </CardHeader>
                      ...
                      >
                        ...
                        >
                          <div className="flex items-start space-x-2">
                            {message.type === "ai" && <Bot className="w-4 h-4 mt-1 text-primary" />}
                            {message.type === "user" && <User className="w-4 h-4 mt-1 text-primary-foreground" />}
                  ...
                  {!isCallActive ? (
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Call our AI assistant for voice-based guidance in your preferred language
                        </p>
                      </div>
                      <div className="space-y-3">
                        <div className="text-sm text-muted-foreground">
                          Available in: Hindi, English, Bengali, Tamil, Telugu, Kannada
                        </div>
                        <Button
                          size="lg"
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-mono text-primary">{formatCallDuration(callDuration)}</p>
                        <p className="text-muted-foreground mt-2">
                          "Hello! I can help you with weather, market prices, and farming advice. What would you like to
                          know?"
                        </p>
                      </div>
                      <div className="flex justify-center space-x-4">
                        ...
                        <Button variant="destructive" onClick={endVoiceCall} className="bg-red-600 hover:bg-red-700">
                          End Call
                        </Button>
                      </div>
                    </div>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Available in 6+ Indian languages</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">High-quality voice synthesis</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Intelligent responses to your queries</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
